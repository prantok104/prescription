...
<section class="admin-area-start">
    ...
    <div class="admin-area">
       <h1 class="text-center text-uppercase text-primary">Medecine Show Tab</h1>
        <div class="prbolem-show-area">
            <ul class="pbl-menu">
                ...
                while($showRow = mysqli_fetch_array($showResult)){
                    echo '<li><a href="illeditmedecine.php?illid='.$showRow['id'].'" class="btn btn-primary text-uppercase">'.$showRow['name'].'</a></li>';
                }
                ?>
            </ul>
        </div>
